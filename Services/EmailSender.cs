...
public class EmailSender : IEmailSender
{
    ...
    {
            string sendGridApiKey = SendGridService.GetSendGridApiKey();
            if (string.IsNullOrEmpty(Options.SendGridKey = sendGridApiKey))
        {
            throw new Exception("Null SendGridKey");
        }
        await Execute(Options.SendGridKey = sendGridApiKey, subject, message, toEmail);
    }
